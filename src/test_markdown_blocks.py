...
"""
        node = markdown_to_html_node(md)
        html = node.to_html()
        self.assertEqual(html, "<div><h1>Heading 1</h1><h2>Heading 2</h2><h4>Heading 3</h4></div>")
...
"""
    ...
    def test_paragraph_heading_quote_code(self):
        md = """
This is the first,
continue on the end.
...
"""
        node = markdown_to_html_node(md)
        html = node.to_html()
        self.assertEqual(html, "<div><p>This is the first, continue on the end.</p><h2>Home</h2><pre><code>this is _italics_\n</code></pre><blockquote>This is blockquote</blockquote></div>")
